  ...
  const dropdowns = [
    {
      ...
      icon: "fas fa-plane",
      links: [
        { to: "/admin/ajouter-voyage", label: "Créer un voyage", icon: "fas fa-plus-circle" },
    ...
    },
    {
      ...
      icon: "fas fa-kaaba",
      links: [
        { to: "/admin/ajouter-omra", label: "Créer Omra", icon: "fas fa-plus-square" },
    ...
    },
    {
      ...
      links: [
        ...
        { to: "/admin/liste-publications", label: "Liste des publications", icon: "fas fa-newspaper" },
      ],
    },
  {
