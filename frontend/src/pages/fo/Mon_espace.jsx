    ...
    <Box sx={{
      ...
      <Section title="Informations personnelles" refProp={personalInfoRef}>
        ...
        <SettingItem
          icon={<Language />}
          text="Pays/région"
          action={<Typography variant="body2">France</Typography>}
        />
        <SettingItem
          icon={<Delete />}
          text="Supprimer le compte"
          action={<Button color="error" variant="outlined">Supprimer</Button>}
        />
      </Section>
      ...
      <Section title="Informations de sécurité">
        <SettingItem
          ...
          action={<Button variant="outlined">Changer</Button>}
        />
        <SettingItem
          icon={<Lock />}
        ...
        <SettingItem
          icon={<Security />}
          text="Configurer la question de sécurité"
          action={<Button variant="outlined">Configurer</Button>}
        />
      </Section>
